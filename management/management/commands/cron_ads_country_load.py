                    ...
                    try:
                        ...
                        if (result_log_res or {}).get('hasil', {}).get('status') and isinstance(result_log_data, dict):
                            params_log = {
                                ...
                                'log_ads_country_frekuensi': float(result_log_data.get('log_ads_country_frekuensi') or 0),
                                'log_ads_country_lpv': float(result_log_data.get('log_ads_country_lpv') or 0),
                                'log_ads_country_lpv_rate': float(result_log_data.get('log_ads_country_lpv_rate') or 0),
                                'mdb': '0',
                        ...
                        if res.get('hasil', {}).get('status'):
                            ...
                            params_log_new = {
                                ...
                                'log_ads_country_frekuensi': record.get('log_ads_country_frekuensi'),
                                'log_ads_country_lpv': record.get('log_ads_country_lpv'),
                                'log_ads_country_lpv_rate': record.get('log_ads_country_lpv_rate'),
                                'mdb': '0',
