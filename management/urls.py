...
urlpatterns = [
    ...
    path('admin/chat_directory', views_chat.ChatDirectoryView.as_view(), name='chat_directory'),
    ...
    path('admin/ads_log_campaign', views.AdsLogCampaignView.as_view(), name='ads_log_campaign'),
    path('admin/page_ads_log_campaign', views.AdsLogCampaignDataView.as_view()),
