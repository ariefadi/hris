...
class data_mysql:
    ...
    def get_all_adx_roi_country_hourly_by_params(self, target_date):
        try:
            base_sql = [
                "SELECT",
                ...
                "WHERE a.log_adx_country_tanggal = %s",
    ...
    def get_all_adx_country_detail_by_params(self, start_date, end_date, selected_account_list = None, selected_domain_list = None, countries_list = None):
        ...
        try:
            ...
            base_sql = [
                ...
                "\tSUM(b.data_adx_country_total_requests) AS 'total_requests',",
                "\tSUM(b.data_adx_country_responses_served) AS 'responses_served',",
                "\tROUND(AVG(b.data_adx_country_match_rate), 2) AS 'match_rate',",
                "\tROUND(AVG(b.data_adx_country_fill_rate), 2) AS 'fill_rate',",
                "\tROUND(AVG(b.data_adx_country_active_view_pct_viewable), 2) AS 'active_view_pct_viewable',",
                "\tROUND(AVG(b.data_adx_country_active_view_avg_time_sec), 2) AS 'active_view_avg_time_sec',",
                "\tSUM(b.data_adx_country_revenue) AS 'revenue'",
                "FROM app_credentials a",
                "INNER JOIN data_adx_country b ON a.account_id = b.account_id",
                "WHERE",
    ...
    def get_all_adsense_country_detail_by_params(self, start_date, end_date, selected_account_list = None, selected_domain_list = None, countries_list = None):
        ...
        try:
            ...
            base_sql = [
                ...
                "\tROUND(AVG(b.data_adsense_country_ad_requests_coverage), 2) AS 'ad_requests_coverage',",
                "\tROUND(AVG(b.data_adsense_country_active_view_viewability), 2) AS 'active_view_viewability',",
                "\tROUND(AVG(b.data_adsense_country_active_view_measurability), 2) AS 'active_view_measurability',",
                "\tROUND(AVG(b.data_adsense_country_active_view_time), 2) AS 'active_view_time',",
                "\tSUM(b.data_adsense_country_revenue) AS 'revenue'",
                "FROM app_credentials a",
                "INNER JOIN data_adsense_country b ON a.account_id = b.account_id",
                "WHERE",
