...
def main():
    ...
    print("FROM app_oauth_credentials")
    ...
    print()
    print("```sql")
    print("UPDATE app_oauth_credentials")
    print("SET google_ads_refresh_token = NULL")
    print("WHERE user_mail = 'aksarabrita470@gmail.com';")
    print("```")
    print()
    ...
    print()
    print("```sql")
    print("SELECT google_ads_refresh_token, updated_at")
    print("FROM app_oauth_credentials")
    print("WHERE user_mail = 'aksarabrita470@gmail.com';")
    print("```")
    print()
